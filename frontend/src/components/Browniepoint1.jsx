...
export default function Browniepoint1({ selectedBuilding }) {
    ...
    const fetchBrowniepoint1Data = async () => {
        ...
        try {
            const [weatherRes, alertsRes, badgesRes] = await Promise.all([
                axios.get(`${API_BASE_URL}/browniepoint1/weather`),
                axios.get(`${API_BASE_URL}/browniepoint1/weather-alerts`),
                axios.get(`${API_BASE_URL}/browniepoint1/badges`)
            ])
    ...
    const calculateCarbonSavings = async (energySaved) => {
        try {
            const res = await axios.post(`${API_BASE_URL}/browniepoint1/carbon-impact`, {
                            ...
                            <div className="bg-white rounded-lg p-6 border border-border-subtle">
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="font-bold text-emerald-600">{carbonImpact.trees_planted}</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex justify-between items-center pt-3 border-t">
                                        ...
                                        <span className="font-bold text-lg text-emerald-600">{carbonImpact.carbon_avoided_kg?.toFixed(2)}</span>
                                    </div>
                                </div>
                            </div>
                        )}
