...
try:
    ...
    from tabtransformertf import TabTransformer
    import mlflow
    import mlflow.tensorflow
    TENSORFLOW_AVAILABLE = True
except ImportError:
    from mock_tensorflow import MockTabTransformerTF
    tf = None
    TabTransformer = MockTabTransformerTF.TabTransformer
...
class TabTransformerModel:
    ...
    def build_model(self) -> tf.keras.Model:
        ...
        categorical_cardinalities = [
            len(feature_vocab[feature]) for feature in categorical_features
        ]
